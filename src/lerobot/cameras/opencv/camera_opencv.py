...
class OpenCVCamera(Camera):
    ...
    def _validate_fps(self) -> None:
        ...
        # Use math.isclose for robust float comparison (use 2% tolerance for FPS as cameras often report slightly different values)
        if not success or not math.isclose(self.fps, actual_fps, rel_tol=0.02, abs_tol=1.0):
